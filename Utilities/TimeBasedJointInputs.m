function stateDot = TimeBasedJointInputs(motionModel, timeInterval, configWaypoints, t, state)

%TimeBasedJointInputs Pass time-varying inputs to the jointSpaceMotionModel derivative
